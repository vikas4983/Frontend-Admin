<?php $__env->startSection('title', 'Keyword Search - Mangal Mandap'); ?>
        					...
        					<div class="col-xs-16 col-lg-16 col-xxl-12 col-xl-12 gt-search-opt mb-20">
        						<div role="tabpanel">
									...
									<div class="tab-content">
										...
										<!-- /.Advance Search  -->
										<!-- Keyword Search  --> 
    									<div role="tabpanel" class="tab-pane active" id="key-search">
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\search\keyword.blade.php ENDPATH**/ ?>