                ...
                <nav class="navbar inPrem2Nav">
                    <div class="container">
                        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(isset($logos->name) && !empty($logos->name)
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div id="owl-demo-2" class="owl-carousel gt-slide-up">
                            <div class="item">
                                <img src="<?php echo e(asset('frontend/assets/images/banners/banner-1.jpg')); ?>" alt="banner-1">
                            </div>
                            <div class="item">
                                <img src="<?php echo e(asset('frontend/assets/images/banners/banner-2.jpg')); ?>" alt="banner-2">
                            </div>
                            <div class="item">
                                <img src="<?php echo e(asset('frontend/assets/images/banners/banner-3.jpg')); ?>" alt="banner-3">
                            </div>
                        </div>
                        <!-- /. Main Carousel -->
                ...
                <div class="col-xxl-16">
                    <div class="row">
                        <div class="col-xxl-5 col-xxl-offset-2">
                            <img src="<?php echo e(asset('frontend/assets/images/android_app_showcase.png')); ?>"
                        ...
                        <div class="col-xxl-8 col-xxl-offset-1 gtAndroidDownDet">
                            ...
                            <a href="Appstore link" target="_blank">
                                <img src="<?php echo e(asset('frontend/assets/images/google_play_download_btn.png')); ?>"
                                    class="img-responsive">
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-8 col-sm-16 col-md-8">
                    <h5 class="gt-text-green gt-font-weight-600">
                        Information </h5>
                    <ul class="">
                        <li><a href="<?php echo e(url('success-story')); ?>">Success Story</a></li>
...
<?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\index.blade.php ENDPATH**/ ?>