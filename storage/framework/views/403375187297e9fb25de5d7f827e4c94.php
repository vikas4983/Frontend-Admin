                ...
                <div class="col-lg-4">
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('paymentgateways.store')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="razorpay_key"
                                            ...
                                            value="<?php echo e(old('razorpay_key')); ?>" required>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="merchant_key"
                                            ...
                                            value="<?php echo e(old('merchant_key')); ?>" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label>Salt</label>
                                        <input type="text" class="form-control" name="salt"
                                            placeholder="Enter Salt "
                                            value="<?php echo e(old('salt')); ?>" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label>Merchant Id</label>
                                        <input type="text" class="form-control" name="merchant_id"
                                            placeholder="Enter Merchant Id "
                                            value="<?php echo e(old('merchant_id')); ?>" required>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="account_name"
                                            ...
                                            value="<?php echo e(old('account_name')); ?>" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label>Bank Account Number</label>
                                        <input type="text" class="form-control" name="bank_account_number"
                                            placeholder="Enter Bank Account Number "
                                            value="<?php echo e(old('bank_account_number')); ?>" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label>Bank IFSC Code</label>
                                        <input type="text" class="form-control" name="bank_ifsc"
                                            placeholder="Enter Bank IFSC Code "
                                            value="<?php echo e(old('bank_ifsc')); ?>" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Account Type</label>
                                        <input type="text" class="form-control" name="bank_account_type"
                                            placeholder="Enter Account Type "
                                            value="<?php echo e(old('bank_account_type')); ?>" required>
                                    </div>
                                   <div class="form-group col-lg-6">
                                        <label>Status</label>
                                        <select name="status" class="form-control" required>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\paymentgateways\create.blade.php ENDPATH**/ ?>