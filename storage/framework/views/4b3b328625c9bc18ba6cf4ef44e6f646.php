<?php $__env->startSection('title', 'Messages-Sent - Mangal Mandap'); ?>
...
<div class="container">
    					<div class="row">
        					<div class="col-xxl-13 col-xxl-offset-3 col-xl-13 col-xl-offset-3 text-center">
            					<h2 class="inPageTitle fontMerriWeather inThemeOrange">
                       				<span class="gt-font-weight-300">Message</span> - Sent                				</h2>
                				<p class="inPageSubTitle">Check all your sent messages from here.</p>
            				</div>
    ...
    <div class="col-xxl-2 col-xs-6 col-sm-6 col-md-8 col-lg-2 gt-margin-top-5">
        <input type="checkbox" class="display-inline" name="msg_id" id="msg_id" value="12" >
        <a class="gt-margin-left-10 font-18 gt-cursor" onClick="importantfun(12,'Yes');">
            <i class="fa fa-star "></i>
        </a>
    </div>

    <a href="inbox_main_msg.php?msg_id=12&sent=1" class="col-xxl-4 col-xs-10 col-sm-10 col-md-8 col-lg-4" data-toggle="tooltip" data-placement="left" title="MM6" >
        <h4 class="name">MM6</h4>
    </a>

    <a href="inbox_main_msg.php?msg_id=12&sent=1" class="col-xxl-8 col-xs-16 col-sm-16 col-md-16 col-lg-8 gt-margin-top-8" title="MM6">
        <span class="font-12">
            <b class="name1">
                ergerger            </b>
        </span>
...
<li>
    <div class="col-xxl-2 col-xs-6 col-sm-6 col-md-8 col-lg-2 gt-margin-top-5">
        <input type="checkbox" class="display-inline" name="msg_id" id="msg_id" value="11" >
        <a class="gt-margin-left-10 font-18 gt-cursor" onClick="importantfun(11,'Yes');">
            <i class="fa fa-star "></i>
        </a>
    </div>

    <a href="inbox_main_msg.php?msg_id=11&sent=1" class="col-xxl-4 col-xs-10 col-sm-10 col-md-8 col-lg-4" data-toggle="tooltip" data-placement="left" title="MM123" >
        <h4 class="name">MM123</h4>
    </a>

    <a href="inbox_main_msg.php?msg_id=11&sent=1" class="col-xxl-8 col-xs-16 col-sm-16 col-md-16 col-lg-8 gt-margin-top-8" title="MM123">
        <span class="font-12">
            <b class="name1">
                ergerger            </b>
        </span>
...
<!-- /.Analytic Code -->
    		...
    		<script src="<?php echo e(asset('assets/js/jquery.bootpag.js')); ?>"></script>
    		<script>
	  		...
	  		<script src="<?php echo e(asset('assets/js/listpagination_search/list.js')); ?>"></script>
			<script src="<?php echo e(asset('assets/js/listpagination_search/list.pagination.js')); ?>"></script> 
			<script type="text/javascript">
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\message\sent.blade.php ENDPATH**/ ?>