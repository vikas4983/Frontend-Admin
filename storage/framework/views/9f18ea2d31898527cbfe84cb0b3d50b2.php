                    ...
                    <div class="gtMobileVerification col-xxl-10 col-xxl-offset-3 col-xs-16 col-xs-offset-0">
                        ...
                        <div class="gtSMSVerification col-xxl-10 col-xxl-offset-3">
                            ...
                            <div class="form-group mt-30">
                                <form action="<?php echo e(route('otp.validate')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views/frontend/users/verification.blade.php ENDPATH**/ ?>