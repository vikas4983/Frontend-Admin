<?php if($inActiveUsers ?? ''): ?>
    <?php $__currentLoopData = $inActiveUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inActiveUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-4 col-xl-4 col-xxl-4">
            <div class="card card-default mt-7">
                <div class="card-body">
                    <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal"
                        data-target="#modal-contact-<?php echo e($inActiveUser->id); ?>">
                        <div class="image mb-3 d-inline-flex mt-n8">
                            <img src="<?php echo e(asset('storage/admin/user-images/' . ($inActiveUser->image ?? 'male-default.jpg'))); ?>"
                                class="img-fluid rounded-circle d-inline-block" alt="Avatar Image" width="100px"
                                height="100px">
                        </div>
                        <h5 class="card-title"><?php echo e($inActiveUser->name ?? ''); ?> (<?php echo e($inActiveUser->id); ?>)
                            <i class="mdi mdi-security"></i>
                            <?php if($inActiveUser->status == 'Active'): ?>
                                <i class="mdi mdi-eye" style="color:rgb(13, 227, 6)"></i>
                            <?php else: ?>
                                <i class="mdi mdi-eye" style="color:rgb(217, 34, 34)"></i>
                            <?php endif; ?>
                            <?php if($inActiveUser->payments->isNotEmpty() && $inActiveUser->payments->last()->is_paid == 1): ?>
                            ...
                            <div class="col">
                                <ul class="list-unstyled d-inline-block mb-5">
                                    <li class="d-flex mb-1">
                                        ...
                                        <span><?php echo e(Str::limit($inActiveUser->email ?? '', 20)); ?></span>
                                    </li>
                                    <li class="d-flex">
        ...
        <div class="modal fade" id="modal-contact-<?php echo e($inActiveUser->id); ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-header justify-content-end border-bottom-0">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <?php if($inActiveUser->payments->isNotEmpty()): ?>
                                    <?php
                                    ...
                                    <?php if($expiryDate->isFuture()): ?>
                                        <button type="button" class="dropdown-item" data-toggle="modal"
                                            data-target="#exampleModal-editPlan<?php echo e($inActiveUser->id); ?>">
                                            <i class="mdi mdi-wallet-membership"></i> Edit Plan
                                        </button>
                                    <?php else: ?>
                                        <button type="button" class="dropdown-item" data-toggle="modal"
                                            data-target="#exampleModal-upgradePlan<?php echo e($inActiveUser->id); ?>">
                                    ...
                                    <div class="card text-center px-0 border-0">
                                        <div class="card-img mx-auto">
                                            <img class="rounded-circle"
                                                src="<?php echo e(asset('storage/admin/user-images/' . ($inActiveUser->image ?? 'male-default.jpg'))); ?>"
                                                alt="user image">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="py-2"><?php echo e($inActiveUser->name ?? ''); ?></h4>
                                            <p><?php echo e($inActiveUser->email ?? ''); ?></p>
                                        ...
                                        <div class="col mt-3">
                                            <ul class="list-unstyled d-inline-block mb-5">
                                                ...
                                                <li class="d-flex mb-1">
                                                    ...
                                                    <span>
                                                        <h6>
                                                            <?php echo e(isset($inActiveUser->created_at) ? \Carbon\Carbon::parse($inActiveUser->created_at)->isoFormat('DD-MMM-YYYY hh:mma') : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\components\in-active-users-component.blade.php ENDPATH**/ ?>