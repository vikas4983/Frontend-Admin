<?php $__env->startSection('title', 'Profile-View-By - Mangal Mandap'); ?>
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            <aside class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center mb-20">
                <h3 class="inPageTitle fontMerriWeather inThemeOrange">My Profile Viewed By</h3>
                <article>
                    <p class="inPageSubTitle">You can check all of your My Profile Viewed By members list here.</p>
                </article>
            </aside>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\profileviewby.blade.php ENDPATH**/ ?>