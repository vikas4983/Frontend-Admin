                ...
                <div class="col-lg-8 col-md-10">
                    <div class="card card-default mb-0">
                        ...
                        <div class="card-body  px-5 pb-5 pt-0">
                          ...
                          <form action="<?php echo e(url('verify-account')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row d-flex justify-content-center mt-1">
                                    <div class="form-group col-lg-8 ">
                                        ...
                                        <input type="text" name="mobile" id="mobile"
                                            ...
                                            placeholder="Enter Mobile/Email" value="<?php echo e(old('mobile')); ?>"
                                            >
...
<?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\verify_account.blade.php ENDPATH**/ ?>