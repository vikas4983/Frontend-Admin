        ...
        <div class="row">
            <div class="col-xxl-4 col-xs-16 col-sm-16 mb-30">
                <div class="thumbnail gt-margin-bottom-0 inHomeMainThumb">
                    <img src="my_photos/watermark.php?image=cropped4874125363721381687.jpg&watermark=watermark.png"
                ...
                <div class="gt-body mb-20 gtHomeBody">
                    <div class="row">
                        <div class="col-xxl-8 col-xl-8 col-lg-10">
                            <h4>
                                Hello <span class="gt-text-orange">Saanvi Acharya</span>
                                <small class="text-muted gt-margin-left-5">( IN1 )</small>
                            </h4>
                            <h5 class="mt-30">
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\dashboard.blade.php ENDPATH**/ ?>