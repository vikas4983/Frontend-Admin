<?php $__env->startSection('title', 'Blocklist-Profiles - Mangal Mandap'); ?>
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            <aside class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center mb-20">
                <h3 class="inPageTitle fontMerriWeather inThemeOrange">Blocklisted Member Profile</h3>
                <article>
                    <p class="inPageSubTitle">You can check all of your blocklisted members list here.</p>
                </article>
            </aside>
            ...
            <div class="col-xxl-12 col-xl-12 col-xs-16" bis_skin_checked="1">
                ...
                <div id="pagination" bis_skin_checked="1">
                    ...
                    <div class="alert alert-info" role="alert" bis_skin_checked="1">
                        <div class="row" bis_skin_checked="1">
                            ...
                            <div class="col-xxl-16 col-xs-16" bis_skin_checked="1">
                                ...
                                <p>Blue color profile is are spotlight profile which was showing top of the search
                                    result.Its gives 10 times faster results.</p>
                    ...
                    <li class="gt-panel gt-panel-default gt-panel-default gt-main-profile">
                            ...
                            <div class="row gt-padding-bottom-15" bis_skin_checked="1">
                                <div class="col-xxl-2 col-xl-2 col-xs-16 col-lg-3 gridFullWidth" bis_skin_checked="1">
                                    <div class="thumbnail gt-margin-bottom-0" bis_skin_checked="1">
                                        ...
                                        <img src="./img/app_img/female-no-photo.jpg" title="Advika Dara" alt="IN40"
                        ...
                        <div class="gt-result-panel-footer" bis_skin_checked="1">
                            <div class="row" bis_skin_checked="1">
                                <div class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                                    <a href="composeMessages?user_id=IN40"
                                    ...
                                    <div class="row" bis_skin_checked="1">
                                        <div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gt-margin-top-10 gridFullWidth"
                                            ...
                                            <a data-toggle="modal" data-target="#myModal1" title="Send Interest"
                                                onclick="ExpressInterest('IN40')" class="btn gt-btn-orange btn-block">
                                        ...
                                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-xs-16 gt-margin-top-10 gridHidden"
                                            ...
                                            <a class="btn btn-default btn-block inResultBlockBtn gt-cursor addToblock-data"
                                                id="IN40" title="Remove Blocklist">
                                                <i class="fas fa-ban gt-margin-right-5" aria-hidden="true"></i>Remove
                                                Blocklist </a>
                                        </div>
                                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-xs-16 gt-margin-top-10 gridHidden"
                                            bis_skin_checked="1">
                        ...
                        addToblock-link"
                                                title="Remove From Shortlist" id="IN40">
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\blocklist.blade.php ENDPATH**/ ?>