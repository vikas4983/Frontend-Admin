...
<?php $component = App\View\Components\CreateButtonComponent::resolve(['createRoute' => ''.e(url('admin/employees/create')).'','activeRoute' => ''.e(url('admin/employees-active')).'','deleteAllRoute' => ''.e(url('admin/employees-destroy')).'','inActiveRoute' => ''.e(url('admin/employees-inActive')).'','countAll' => ''.e($countAll).'','active' => ''.e($active).'','inActive' => ''.e($inActive).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                                ...
                                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="selectCheckbox" name="selectedIds[]"
                                                value="<?php echo e($employee->id); ?>"></td>
                                        <td>
...
<?php $component = App\View\Components\EditActionButtonComponent::resolve(['editRoute' => route('employees.edit', $employee->id),'id' => $employee->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\DestroyActionButtonComponent::resolve(['destroyRoute' => route('employees.destroy', $employee->id),'id' => $employee->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\StatusComponent::resolve(['status' => $employee->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php echo e($employee->employee); ?>
                        ...
                        <div class="d-flex justify-content-center">
                            <span><?php echo e($employees->links()); ?></span>
                        </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\employees\index.blade.php ENDPATH**/ ?>