    ...
    <div id="body" style="display:none">
        <div id="wrap">
            <div id="main">
                <!-- Header & Menu -->
                <!-- Font Awsome -->
                <link href="<?php echo e(asset('frontend/assets/css/font/css/fontawesome.min.css')); ?>" rel="stylesheet">
                <link href="<?php echo e(asset('frontend/assets/css/font/css/all.min.css')); ?>" rel="stylesheet">
                ...
                <header class="container">
                    <div class="row">
                        ...
                        <div class="col-xxl-5 col-xl-4 col-xs-8 col-md-8 col-lg-5">
                            <a href="<?php echo e(url('dashboard')); ?>" class="ripplelink">
                        ...
                        <div
                            class="col-sm-10 col-xs-10 col-md-10 visible-xs visible-sm visible-md pull-right text-right gt-padding-top-10">
                            <a class="btn gt-btn-orange" role="button" data-toggle="collapse"
                                href="#collapseHeadDetails" aria-expanded="false" aria-controls="collapseHeadDetails">
                                <p class="gt-margin-bottom-0 gt-margin-top-0">
                                    <?php echo e($user->name ?? 'Gaust'); ?></b>&nbsp;&nbsp;<i class="fa fa-angle-down"></i></p>
                            </a>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-11 col-xs-12 col-md-11">
                                        <h5 class="gt-margin-bottom-5 gt-margin-top-5">
                                            <b><?php echo e($user->name ?? 'Gaust'); ?></b> : <b><span
                                                    class="gt-text-orange"><?php echo e($prefix->name ?? 'NA'); ?>-<?php echo e($user->id); ?></span></b>
                                        </h5>
                                        ...
                                        <?php if(isset($latestPayment)): ?>
                                            ...
                                            <p class="gt-margin-bottom-5 font-13">Contact :
                                                <?php echo e($latestPayment->contact ?? 'NA'); ?> <span
                                                    class="gt-text-orange"></span>
                                            </p>
                                        <?php else: ?>
                                            <p class="gt-margin-bottom-5 font-13">Membership :
                                                Free <span class="gt-text-orange"></span>
                                            </p>
                                        <?php endif; ?>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-left">
                                <li class="active ripplelink"><a href="<?php echo e(url('dashboard')); ?>">My Home</a></li>
                                <li class="dropdown">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown gt-border-right-green gt-border-left-green">
                                    <a href="#" class="dropdown-toggle ripplelink pl-30 pr-30"
                                ...
                                <li class="dropdown gt-border-right-green">
                                    <a href="#" class="dropdown-toggle ripplelink pl-30 pr-30"
                                        ...
                                        <i class="fa fa-bell"></i> <span
                                            class="hidden-xxl hidden-xl hidden-lg">Notification</span>
                ...
                <div class="container-fluid gt-footer-bottom">
                    <div class="row">
                        <div class="container text-center">
                            All Rights Reserved By @ <a href="https://matrimonialphpscript.com/premium-demo-2/">Design
                                and developed by Matrimonywebsite</a>
                        </div>
                    </div>
                </div>
...
-->
            ...
            <script src="<?php echo e(asset('frontend/assets/js/function.js')); ?>" type="text/javascript"></script>
</body>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            <script src="<?php echo e(asset('frontend/assets/js/custom-js/user-update-modal.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\layouts\frontend\main-master.blade.php ENDPATH**/ ?>