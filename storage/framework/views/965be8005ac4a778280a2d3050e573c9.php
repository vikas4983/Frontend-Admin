;
<?php $__env->startSection('title', 'City - Edit | Admin'); ?>
                ...
                <div class="card-header">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit City > <?php echo e($city->city); ?> </li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="card card-default">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('cities.update', $city->id)); ?>" method="post">
                            ...
                            <select name="state_id" id="state_id" class="form-control">
                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($state->id); ?>"
                                        <?php echo e(old('state_id', $city->state_id) == $state->id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group">
                            <label>City</label>
                            <input class="form-control" value="<?php echo e(old('city') ?? $city->city); ?>" name="city"
                        ...
                        <div class="custom-control custom-radio d-inline-block mr-3 mb-3">
                            <input type="radio" id="customRadio1" name="status" class="custom-control-input"
                                value="1" <?php echo e($city->status == 'Active' ? 'checked' : ''); ?>>
                            <label class="custom-control-label" for="customRadio1">Active</label>
                        </div>

                        <div class="custom-control custom-radio d-inline-block mr-3 mb-3">
                            <input type="radio" id="customRadio2" name="status" class="custom-control-input"
                                value="0" <?php echo e($city->status == 'Inactive' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\countries\states\cities\edit.blade.php ENDPATH**/ ?>