...
<div class="card card-default">
      <div class="card-header">
        ...
        <button type="button" class="mb-3 btn btn-lg btn-outline-primary" data-toggle="modal" data-target="#emailTemplateCreate">
...
<?php endif; ?><?php echo e($emailTemplat->name); ?>
              ...
              <td><?php echo e($emailTemplat->body ?? ''); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\emailTemplates\index.blade.php ENDPATH**/ ?>