...
<?php $component = App\View\Components\EditActionButtonComponent::resolve(['editRoute' => route('siteSettings.edit', $siteSetting->id),'id' => $siteSetting->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\DestroyActionButtonComponent::resolve(['destroyRoute' => route('siteSettings.destroy', $siteSetting->id),'id' => $siteSetting->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12  mb-3">
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            ...
                                                                            <p class="card-text"><?php echo e($siteSetting->name); ?>

                                                                            </p>
                                                                        </div>
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            <h6 style="color:yellow"> Title</h6>
                                                                            <p class="card-text"><?php echo e($siteSetting->title); ?>
                                                                        ...
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            ...
                                                                            <p class="card-text">
                                                                                <?php echo e($siteSetting->description); ?>

                                                                            </p>
                                                                        </div>
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            <h6 style="color:yellow"> Number</h6>
                                                                            <p class="card-text"><?php echo e($siteSetting->number); ?>

                                                                            </p>
                                                                        </div>
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            <h6 style="color:yellow"> Email</h6>
                                                                            <p class="card-text"><?php echo e($siteSetting->email); ?>
                                                                        ...
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            ...
                                                                            <p class="card-text">
                                                                                <?php echo e($siteSetting->google_analytics_code); ?>

                                                                            </p>
                                                                        </div>
                                                                        <div class="card text-white bg-primary mt-3">
                                                                            <h6 style="color:yellow"> Footer </h6>
                                                                            <p class="card-text"><?php echo e($siteSetting->footer); ?>
...
<?php $component = App\View\Components\StatusComponent::resolve(['status' => $siteSetting->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                            <?php echo e($siteSetting->name); ?></td>
                                        <td><?php echo e(Str::limit($siteSetting->title, 15)); ?></td>
                                        <td><?php echo e(Str::limit($siteSetting->description, 15)); ?></td>
                        ...
                        <div class="d-flex justify-content-center">
                            <span><?php echo e($siteSettings->links()); ?></span>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\siteSettings\index.blade.php ENDPATH**/ ?>