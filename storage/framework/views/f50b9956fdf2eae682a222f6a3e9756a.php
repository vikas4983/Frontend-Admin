<?php $__env->startSection('title', 'Basic Search - Mangal Mandap'); ?>
        					...
        					<div class="col-xs-16 col-lg-16 col-xxl-12 col-xl-12 gt-search-opt mb-20">
        						<div role="tabpanel">
									...
									<div class="tab-content">
										...
										<!-- /.Quick Search -->
										<!-- Basic Search  --> 
    									<div role="tabpanel" class="tab-pane active" id="basic-search">
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
...
<!-- /.Analytic Code -->
        ...
        <!-- Responsive Tab js -->
        <script src="<?php echo e(asset('asset/js/jquery.bootstrap-responsive-tabs.min.js')); ?>" type="text/javascript"></script>
        <script>
			$('.responsive-tabs').responsiveTabs({
  			accordionOn: ['xs', 'sm']
		});
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\search\basic.blade.php ENDPATH**/ ?>