<?php $__env->startSection('title', ' Countries | Admin'); ?>
...
<?php $component = App\View\Components\CreateButtonComponent::resolve(['createRoute' => ''.e(url('admin/countries/create')).'','deleteAllRoute' => ''.e(url('admin/countries-destroy')).'','activeRoute' => ''.e(url('admin/countries-active')).'','inActiveRoute' => ''.e(url('admin/countries-inActive')).'','countAll' => ''.e($countAll).'','active' => ''.e($active).'','inActive' => ''.e($inActive).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="selectCheckbox" name="selectedIds[]"
                                                value="<?php echo e($country->id); ?>"></td>
                                        <td>
...
<?php $component = App\View\Components\EditActionButtonComponent::resolve(['editRoute' => route('countries.edit', $country->id),'id' => $country->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\DestroyActionButtonComponent::resolve(['destroyRoute' => route('countries.destroy', $country->id),'id' => $country->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\StatusComponent::resolve(['status' => $country->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php echo e($country->country); ?>
                        ...
                        <div class="d-flex justify-content-center">
                            <span><?php echo e($countries->links()); ?></span>
                        </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\countries\index.blade.php ENDPATH**/ ?>