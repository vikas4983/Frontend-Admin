<?php $__env->startSection('title', ' States | Admin'); ?>
...
<?php $component = App\View\Components\CreateButtonComponent::resolve(['createRoute' => ''.e(url('admin/states/create')).'','deleteAllRoute' => ''.e(url('admin/states-destroy')).'','activeRoute' => ''.e(url('admin/states-active')).'','inActiveRoute' => ''.e(url('admin/states-inActive')).'','countAll' => ''.e($countAll).'','active' => ''.e($active).'','inActive' => ''.e($inActive).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\ActionButton::resolve(['destroyRoute' => ''.e(route('states.destroy', $state->id)).'','editRoute' => ''.e(route('states.edit', $state->id)).'','id' => '$state->id','entityType' => '\'state\''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\StatusComponent::resolve(['status' => $state->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php echo e($state->state); ?></td>
                                    <td><?php echo e($state->country->country); ?></td>
                    ...
                    <div class="d-flex justify-content-center">
                        <span><?php echo e($states->links()); ?></span>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\countries\states\index.blade.php ENDPATH**/ ?>