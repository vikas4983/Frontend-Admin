<?php $__env->startSection('title', 'Advance Search - Mangal Mandap'); ?>
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            <div class="col-xs-16 col-lg-16 col-xxl-16 col-xl-16 mb-20">
                <h2 class="inPageTitle fontMerriWeather">Search Options</h2>
                <p class="inPageSubTitle">Search perfect partner with our multiple search options which help you to find out
            ...
            <div class="col-xs-16 col-lg-16 col-xxl-12 col-xl-12 gt-search-opt mb-20">
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        <!-- Quick Search -->
                        <div role="tabpanel" class="tab-pane " id="quick-search">
                            <div class="row">
                                <div class="col-xxl-14 col-xxl-offset-1">
                                    ...
                                    <form action="" id="quick_search_form" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a Religion"
                                                        class="chosen-select gt-form-control flat" multiple tabindex="5"
                                                        id="religion_id" name="religion_id[]">
                                                        <option value="52">
                                                            Buddhist </option>
                                                        <option value="46">
                                                            Christian </option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a Caste"
                                                        class="chosen-select gt-form-control flat" multiple tabindex="4"
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <a class="btn gt-btn-green gt-cursor" href="saved-searches">Saved Search</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            <select class="gt-form-control flat" name="from_height"
                                                                id="from_height_basic">
                                                                <option value="1">Below 4ft 6in - 137cm</option>
                                                                <option value="2" selected>4ft 6in - 137cm</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a Religion"
                                                        class="chosen-select gt-form-control flat" multiple tabindex="5"
                                                        id="religion_id_basic" name="religion_id[]">
                                                        <option value="52">
                                                            Buddhist </option>
                                                        <option value="46">
                                                            Christian </option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a Country"
                                                        class="chosen-select gt-form-control flat" multiple tabindex="4"
                                                        id="country_id_bsc" name="country_id[]">
                                                        <option value=""></option>
                        ...
                        <!-- /.Basic Search  -->
                        <!-- Advance Search  -->
                        <div role="tabpanel" class="tab-pane active" id="adv-search">
                            <div class="row">
                                <div class="col-xxl-14 col-xxl-offset-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <select class="gt-form-control flat" name="to_height"
                                                                id="part_to_height_adv">
                                                                <option value="1" disabled>Below 4ft 6in - 137cm
                                                                </option>
                                                                <option value="2" disabled>4ft 6in - 137cm</option>
                                                                <option value="3" disabled>4ft 7in - 139cm</option>
                                                                <option value="4" disabled>4ft 8in - 142cm</option>
                                                                <option value="5" disabled>4ft 9in - 144cm</option>
                                                                <option value="6" disabled>4ft 10in - 147cm</option>
                                                                <option value="7" disabled>4ft 11in - 149cm</option>
                                                                <option value="8" disabled>5ft - 152cm</option>
                                                                <option value="9" disabled>5ft 1in - 154cm</option>
                                                                <option value="10" disabled>5ft 2in - 157cm</option>
                                                                <option value="11" disabled>5ft 3in - 160cm</option>
                                                                <option value="12" disabled>5ft 4in - 162cm</option>
                                                                <option value="13" disabledselected>5ft 5in - 165cm
                                                                </option>
                                                                <option value="14">5ft 6in - 167cm</option>
                                                                <option value="15">5ft 7in - 170cm</option>
                                                                <option value="16">5ft 8in - 172cm</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a Religion"
                                                        class="chosen-select gt-form-control flat" multiple
                                                        tabindex="5" id="religion_id_adv" name="religion_id[]">
                                                        <option value="52">
                                                            Buddhist </option>
                                                        <option value="46">
                                                            Christian </option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a Country"
                                                        class="chosen-select gt-form-control flat" multiple
                                                        tabindex="4" id="country_id_adv" name="country_id[]">
                                                        <option value=""></option>
                                                        <option value="1">Andorra</option>
                                                        <option value="2">United Arab Emirates</option>
                                                        <option value="3">Afghanistan</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-10 col-xl-10">
                                                    <select data-placeholder="Choose a State"
                                                        class="chosen-select gt-form-control flat" multiple
                                                        tabindex="4" id="state_id_adv" name="state_id[]">
                                                        <option value=""></option>
                                                    </select>
                            ...
                            <div class="row">
                                <div class="col-xxl-14 col-xxl-offset-1">
                                    <h3 class="inSearchTitle">
                                        Location Search </h3>
                                    <p class="pb-10 gt-border-bottom-smoke-white inSearchSubTitle">
                                        With Location search, you can get suitable profiles from specific location or place.
                                    </p>
...
<!-- /.Analytic Code -->
        ...
        <!-- Responsive Tab js -->
        <script src="<?php echo e(asset('assets/js/jquery.bootstrap-responsive-tabs.min.js')); ?>" type="text/javascript"></script>
        <script>
		...
		<script>
     	...
     	<!-- Chosen Js -->
     	<script src="<?php echo e(asset('assets/js/chosen.jquery.js')); ?>" type="text/javascript"></script>
     	<script src="<?php echo e(asset('assets/js/prism.js')); ?>" type="text/javascript" charset="utf-8"></script>
		<script type="text/javascript">
			var config = {
			'.chosen-select'           : {},
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\search\advance.blade.php ENDPATH**/ ?>