 <div style="padding: 0.56rem 1.5rem;
     ...
     <a href="<?php echo e(url($createRoute)); ?>" class="btn btn-primary btn-sm"><i class=" fa fa-add"></i> <b>Create</b></a>

     
     <button class="btn btn-info btn-sm"><i class=" mdi mdi-format-list-bulleted"></i> <b>List</b><span
             class="badge text-bg-secondary"><?php echo e($countAll); ?></span>
     </button>
     ...
     <button>
         <form action="<?php echo e(url($deleteAllRoute)); ?>" method="post" id="deleteForm">
             <?php echo csrf_field(); ?>
     ...
     <button>
         <form action="<?php echo e(url($activeRoute)); ?>" id="activeBtnForm" method="post">
             <!-- For CMS -->
             ...
             <button class="btn btn-success btn-sm" id="activeBtn"><i class=" mdi mdi-check-decagram"></i>
                 <b>Active</b><span class="badge text-bg-secondary"><b><?php echo e($active); ?></b></span></button>
         </form>
     </button>
     ...
     <button>
         <form action="<?php echo e(url($inActiveRoute)); ?>" id="inActiveBtnForm" method="post">
             <!-- For CMS -->
            ...
            <!-- For Favicon -->
             ...
             <button class="btn btn-secondary btn-sm" id="inActiveBtn"><i class=" mdi mdi-close-octagon"></i>
                 <b>InActive</b><span class="badge text-bg-secondary"><b><?php echo e($inActive); ?></b></span></button>
         </form>
     </button>
 </div>
<?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\components\create-button-component.blade.php ENDPATH**/ ?>