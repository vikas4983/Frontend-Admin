<?php $__env->startSection('title', ' Cities | Admin'); ?>
...
<?php $component = App\View\Components\CreateButtonComponent::resolve(['createRoute' => ''.e(url('admin/cities/create')).'','deleteAllRoute' => ''.e(url('admin/cities-destroy')).'','activeRoute' => ''.e(url('admin/cities-active')).'','inActiveRoute' => ''.e(url('admin/cities-inActive')).'','countAll' => ''.e($countAll).'','active' => ''.e($active).'','inActive' => ''.e($inActive).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\ActionButton::resolve(['destroyRoute' => ''.e(route('cities.destroy', $city->id)).'','editRoute' => ''.e(route('cities.edit', $city->id)).'','id' => '$city->id','entityType' => '\'city\''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\StatusComponent::resolve(['status' => $city->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php echo e($city->city); ?>

                                        </td>
                                        <td><?php echo e($city->state->state ?? ''); ?> </td>
                        ...
                        <div class="d-flex justify-content-center">
                            <span><?php echo e($cities->links()); ?></span>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\countries\states\cities\index.blade.php ENDPATH**/ ?>