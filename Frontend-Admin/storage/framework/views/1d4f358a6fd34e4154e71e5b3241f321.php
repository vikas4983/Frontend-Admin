<?php $__env->startSection('title', 'Sortlist Profile - Mangal Mandap'); ?>
        ...
        <div class="row">
            <aside class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center mb-20">
                <h3 class="inPageTitle fontMerriWeather inThemeOrange">
                    Shortlisted Member Profile </h3>
                <article>
                    <p class="inPageSubTitle">You can check all of your shortlisted members list here.</p>
                </article>
            </aside>
                ...
                <div class="collapse mobile-collapse" id="collapseExample">
                    <div class="gt-panel gt-panel-orange inHomeLeftPanel">
                        ...
                        <div class="gt-left-pan-option">
                            <div class="row">
                                <a href="<?php echo e(url("messages-inbox")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                ...
                                <a href="<?php echo e(url("messages-sent")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink inBRBtm5">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                            Outbox </div>
                                        <span class="col-xxl-3 col-xs-3 col-xl-4">
                    ...
                    <div class="gt-panel gt-panel-orange inHomeLeftPanel">
                        ...
                        <div class="gt-left-pan-option">
                            <div class="row">
                                <a href="<?php echo e(url("my-profile")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    Edit Profile </a>
                                <a href="<?php echo e(url("my-photos")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink inBRBtm5">
                                    Manage Photos </a>
                            </div>
                        </div>
                    </div>
                    <div class="gt-panel gt-panel-orange inHomeLeftPanel">
                        ...
                        <div class="gt-left-pan-option">
                            <div class="row">
                                <a href="<?php echo e(url("my-interest")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(url("sortlist-profiles")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(url("blocklist-profiles")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(url("profiles-view-by")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(url("i-view-profiles")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(url("mobile-numbers-view-by")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
                                ...
                                <a href="<?php echo e(url("i-view-mobile-numbers")); ?>" class="col-xxl-16 col-xl-16 col-xs-16 ripplelink">
                                    <div class="row">
                                        <div class="col-xxl-13 col-xl-12 col-xs-13">
...
<div class="alert alert-info" role="alert" bis_skin_checked="1">
    <div class="row" bis_skin_checked="1">
        ...
        <div class="col-xxl-16 col-xs-16" bis_skin_checked="1">
            ...
            <p><span style="color:red;"><b>3</b></span> Profiles found </p>
        </div>
    </div>
</div>    
<li class="gt-panel gt-panel-default gt-panel-default gt-main-profile">
	<a href="member-profile?view_id=IN39" target="_blank" class="gt-panel-head">
    	<div class="row" bis_skin_checked="1">
      		...
      		<div class="col-xxl-11 col-xl-11 col-lg-11 col-xs-16 text-right gridHidden" bis_skin_checked="1">
        		<h5 class="gt-margin-top-5 gt-margin-bottom-0">
         			Register On: 07 Sep 2022 ,09:59 AM        		</h5>
      		</div>
     	</div>
  	</a>
  	<a href="member-profile?view_id=IN39" target="_blank" class="gt-result-panel-body">
    	<div class="row gt-padding-bottom-15" bis_skin_checked="1">
			<div class="col-xxl-2 col-xl-2 col-xs-16 col-lg-3 gridFullWidth" bis_skin_checked="1">
				...
				<img src="./img/app_img/female-no-photo.jpg" title="Anaya Varma" alt="IN39" class="img-responsive gtFullWidth">               
          			...
          			<div class="redirect" bis_skin_checked="1">
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-xs-16 gridHidden" bis_skin_checked="1">
                            <p class="row gt-margin-bottom-0">
                                ...
                                <span class="col-xs-9">
                                     B Plan,  Company Secretary (CS)                                </span>
                            </p>
                        </div>
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-xs-16 gridHidden" bis_skin_checked="1">
                            <p class="row gt-margin-bottom-0">
    ...
    <div class="gt-result-panel-footer" bis_skin_checked="1">
        <div class="row" bis_skin_checked="1">
            <div class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                <a href="composeMessages?user_id=IN39" class="btn btn-default btn-block inResultSendMessageBtn">
            ...
            <div class="col-xxl-11 col-xl-11 col-lg-11 pull-right gridFullWidth" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gt-margin-top-10 gridFullWidth" bis_skin_checked="1">
                        ...
                        <a data-toggle="modal" data-target="#myModal1" title="Send Interest" onclick="ExpressInterest('IN39')" class="btn gt-btn-orange btn-block">
                        ...
                        addToshort-data" id="IN39" title="Add to Blocklist">
                        ...
                        addToblock-link" title="Remove From Shortlist" id="IN39">
                            <i class="fa fa-sort gt-margin-right-5" aria-hidden="true"></i>                        </a>
                    </div>
                                    </div>
            </div>
        </div>
    </div>
</li><li class="gt-panel gt-panel-default gt-panel-default gt-main-profile">
	<a href="member-profile?view_id=IN40" target="_blank" class="gt-panel-head">
    	<div class="row" bis_skin_checked="1">
      		<div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gridFullWidth gt-main-name" bis_skin_checked="1">
        		<h4 class="gt-margin-top-0 gt-margin-bottom-0 inThemeOrange">
          		Advika Dara                ( IN40 )	
      		...
      		<div class="col-xxl-11 col-xl-11 col-lg-11 col-xs-16 text-right gridHidden" bis_skin_checked="1">
        		<h5 class="gt-margin-top-5 gt-margin-bottom-0">
         			Register On: 07 Sep 2022 ,10:03 AM        		</h5>
      		</div>
     	</div>
  	</a>
  	<a href="member-profile?view_id=IN40" target="_blank" class="gt-result-panel-body">
    	<div class="row gt-padding-bottom-15" bis_skin_checked="1">
			<div class="col-xxl-2 col-xl-2 col-xs-16 col-lg-3 gridFullWidth" bis_skin_checked="1">
				<div class="thumbnail gt-margin-bottom-0" bis_skin_checked="1">
				  	  
				<img src="./img/app_img/female-no-photo.jpg" title="Advika Dara" alt="IN40" class="img-responsive gtFullWidth">               
    ...
    <div class="gt-result-panel-footer" bis_skin_checked="1">
        <div class="row" bis_skin_checked="1">
            <div class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                <a href="composeMessages?user_id=IN40" class="btn btn-default btn-block inResultSendMessageBtn">
                    <i class="fas fa-envelope" aria-hidden="true"></i> Send Message                </a>
            </div>
            <div class="col-xxl-11 col-xl-11 col-lg-11 pull-right gridFullWidth" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gt-margin-top-10 gridFullWidth" bis_skin_checked="1">
                        ...
                        <a data-toggle="modal" data-target="#myModal1" title="Send Interest" onclick="ExpressInterest('IN40')" class="btn gt-btn-orange btn-block">
                            <i class="fas fa-heart gt-margin-right-5" aria-hidden="true"></i>Send Interest                        </a>
                                            </div>
                     
                    <div class="col-xxl-5 col-xl-5 col-lg-5 col-xs-16 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                        <a class="btn btn-default btn-block inResultBlockBtn gt-cursor addToblock-data" id="IN40" title="Remove Blocklist">
                            <i class="fas fa-ban gt-margin-right-5" aria-hidden="true"></i>Remove Blocklist                        </a>
                    </div>
                                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-xs-16 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                        <a class="btn btn-default btn-block  inResultShortBtn gt-cursor 
                        addToblock-link" title="Remove From Shortlist" id="IN40">
                            <i class="fa fa-sort gt-margin-right-5" aria-hidden="true"></i>                        </a>
                    </div>
                                    </div>
            </div>
	...
	<a href="member-profile?view_id=IN41" target="_blank" class="gt-panel-head">
    	<div class="row" bis_skin_checked="1">
      		<div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gridFullWidth gt-main-name" bis_skin_checked="1">
        		<h4 class="gt-margin-top-0 gt-margin-bottom-0 inThemeOrange">
          		Mamatha Surekha                ( IN41 )	
				</h4>
      		</div>
      		<div class="col-xxl-11 col-xl-11 col-lg-11 col-xs-16 text-right gridHidden" bis_skin_checked="1">
        		<h5 class="gt-margin-top-5 gt-margin-bottom-0">
         			Register On: 01 Mar 2024 ,04:17 AM        		</h5>
      		</div>
     	</div>
  	</a>
  	<a href="member-profile?view_id=IN41" target="_blank" class="gt-result-panel-body">
    	<div class="row gt-padding-bottom-15" bis_skin_checked="1">
			<div class="col-xxl-2 col-xl-2 col-xs-16 col-lg-3 gridFullWidth" bis_skin_checked="1">
				<div class="thumbnail gt-margin-bottom-0" bis_skin_checked="1">
				  	  
				<img src="./img/app_img/female-no-photo.jpg" title="Mamatha Surekha" alt="IN41" class="img-responsive gtFullWidth">               
    ...
    <div class="gt-result-panel-footer" bis_skin_checked="1">
        <div class="row" bis_skin_checked="1">
            <div class="col-xxl-4 col-xl-4 col-lg-4 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                <a href="composeMessages?user_id=IN41" class="btn btn-default btn-block inResultSendMessageBtn">
                    <i class="fas fa-envelope" aria-hidden="true"></i> Send Message                </a>
            </div>
            <div class="col-xxl-11 col-xl-11 col-lg-11 pull-right gridFullWidth" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-xxl-5 col-xl-5 col-xs-16 col-lg-5 gt-margin-top-10 gridFullWidth" bis_skin_checked="1">
                        ...
                        <a data-toggle="modal" data-target="#myModal1" title="Send Interest" onclick="ExpressInterest('IN41')" class="btn gt-btn-orange btn-block">
                            <i class="fas fa-heart gt-margin-right-5" aria-hidden="true"></i>Send Interest                        </a>
                                            </div>
                                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-xs-16 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                        <a class="btn btn-default btn-block inResultBlockBtn gt-cursor 
                        addToshort-data" id="IN41" title="Add to Blocklist">
                            <i class="fas fa-ban gt-margin-right-5" aria-hidden="true"></i>Add to Blocklist                        </a>
                    </div>
                                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-xs-16 gt-margin-top-10 gridHidden" bis_skin_checked="1">
                        <a class="btn btn-default btn-block  inResultShortBtn gt-cursor 
                        addToblock-link" title="Remove From Shortlist" id="IN41">
                            <i class="fa fa-sort gt-margin-right-5" aria-hidden="true"></i>                        </a>
                    </div>
                                    </div>
            </div>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\sortlist.blade.php ENDPATH**/ ?>