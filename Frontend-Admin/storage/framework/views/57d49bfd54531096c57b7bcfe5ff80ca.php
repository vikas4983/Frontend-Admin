                    ...
                    <div class="card card-default mb-0">
                        <div class="card-header pb-0">
                            <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                                <a class="w-auto pl-0" href="<?php echo e(url('admin-login')); ?>">
                        ...
                        <div class="card-body px-5 pb-5 pt-0">
                            ...
                            <form action="<?php echo e(url('admin-validate')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
<?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin-login.blade.php ENDPATH**/ ?>