<?php $__env->startSection('title', 'Occupation Search - Mangal Mandap'); ?>
<?php $__env->startSection('content'); ?>
<div class="container">
    					<div class="row">
        					<div class="col-xs-16 col-lg-16 col-xxl-16 col-xl-16 mb-20">
            					<h2 class="inPageTitle fontMerriWeather">Search Options</h2>
                				<p class="inPageSubTitle">Search perfect partner with our multiple search options which help you to find out perfect partner for life.</p>
            				</div>
        					...
        					<div class="col-xs-16 col-lg-16 col-xxl-12 col-xl-12 gt-search-opt mb-20">
        						<div role="tabpanel">
									...
									<div class="tab-content">
																	...
																	<div class="row">
																		...
																		<div class="col-xs-6">
																			<select class="gt-form-control flat" name="to_height" id="part_to_height_adv">
																				                                                                                    <option value="1" disabled>Below 4ft 6in - 137cm</option>
                                                                                                                                                                    ...
                                                                                                                                                                    <option value="13" disabledselected>5ft 5in - 165cm</option>
                                                                                                                                                                    <option value="14" >5ft 6in - 167cm</option>
                                                                                                                                                                    <option value="15" >5ft 7in - 170cm</option>
                                                                                                                                                                    <option value="16" >5ft 8in - 172cm</option>
                                                                                                                                                                    <option value="17" >5ft 9in - 175cm</option>
										...
										<!-- /.Location Search  -->
										<!-- Occupation Search  --> 
                        				<div role="tabpanel" class="tab-pane active" id="oct-search">
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
													<h3 class="inSearchTitle">
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\search\occupation.blade.php ENDPATH**/ ?>