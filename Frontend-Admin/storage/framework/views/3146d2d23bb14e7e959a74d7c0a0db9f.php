...
<?php endif; ?>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-8 text-right">
                                            <a href="forgot-password1" class="inForgotText">Forgot Password ? </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group text-center">
                                    <a href="#loginWithOTP" data-toggle="modal" class="btn gt-btn-green btn-block">Login
                                        With OTP</a>
                                </div>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\auth\login.blade.php ENDPATH**/ ?>