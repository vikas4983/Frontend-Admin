<?php $__env->startSection('title', 'My Horoscope - Mangal Mandap'); ?>
<?php $__env->startSection('content'); ?>
<div class="container gt-margin-top-20">
						<div class="row">
							<div class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center gt-margin-bottom-20">
								<h3 class="inPageTitle fontMerriWeather inThemeOrange">Upload Horoscope</h3>
								<article>
							...
							<div class="col-xxl-12 col-xl-12 col-xs-16 col-sm-16 col-md-16 gt-upload-photo">
								...
								<div class="gt-profile-pic-title">
									<div class="col-xxl-10 col-xl-10 col-xs-16 col-sm-16 col-md-16 gt-upload-photo">
										<h4>Change Or Upload Horoscope</h4>
									</div>
							   	</div>
									...
									<div class="row">
										...
										<div class="col-md-8 gt-margin-bottom-15">
											...
											<div class="row gt-margin-bottom-15">
												...
												<div class="col-xs-10"> 
													<b> Years  Month  Days</b>
												</div>
											</div>
											<div class="row gt-margin-bottom-15">
												<div class="col-xs-6"> Raasi </div>
												<div class="col-xs-10"> <b>5</b> </div>
											</div>
											<div class="row gt-margin-bottom-15">
											...
											<form>
												<div class="row">
													<div class="col-xs-4 gt-margin-bottom-15">
														<input type="text" class="gt-form-control" value="" disabled> </div>
													<div class="col-xs-4 gt-margin-bottom-15">
														<input type="text" class="gt-form-control" value="" disabled> </div>
													<div class="col-xs-4 gt-margin-bottom-15">
														<input type="text" class="gt-form-control" value="" disabled> </div>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\horoscope.blade.php ENDPATH**/ ?>