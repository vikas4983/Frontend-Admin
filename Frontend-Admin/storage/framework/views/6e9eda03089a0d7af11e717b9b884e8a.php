...
<?php $component = App\View\Components\CreateButtonComponent::resolve(['createRoute' => ''.e(url('admin/cmsPages/create')).'','deleteAllRoute' => ''.e(url('admin/cms-destroy')).'','activeRoute' => ''.e(url('admin/cms-active')).'','inActiveRoute' => ''.e(url('admin/cms-inActive')).'','countAll' => ''.e($countAll).'','active' => ''.e($active).'','inActive' => ''.e($inActive).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                                ...
                                <?php $__currentLoopData = $cmspages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cmspage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="selectCheckbox" name="selectedIds[]"
                                                value="<?php echo e($cmspage->id); ?>"></td>
...
<?php $component = App\View\Components\ActionButton::resolve(['destroyRoute' => ''.e(route('cmsPages.destroy', $cmspage->id ?? '')).'','editRoute' => ''.e(route('cmsPages.edit', $cmspage->id ?? '')).'','id' => '$logo->id','entityType' => '\'logos\''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                            <a href="<?php echo e(route('cmsPages.show',$cmspage->slug)); ?>"
...
<?php $component = App\View\Components\StatusComponent::resolve(['status' => $cmspage->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php echo e($cmspage->name); ?></td>
                                        <td><?php echo e($cmspage->slug); ?></td>
                                        <td><?php echo e($cmspage->title); ?></td>
                                        <td><?php echo e(Str::limit($cmspage->content, 20)); ?></td>
                        ...
                        <div class="d-flex justify-content-center">
                            <span><?php echo e($cmspages->links()); ?></span>
                        </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\cmspages\index.blade.php ENDPATH**/ ?>