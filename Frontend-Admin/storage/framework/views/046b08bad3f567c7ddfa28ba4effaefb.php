...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <form action="" method="post" name="change_pass" id="change_pass">
                                            <div
                                                ...
                                                <input type="password" id="old_pass" name="old_pass"
                                                    data-validetta="required" class="gt-form-control">
                                            ...
                                            <div
                                                ...
                                                <input type="password" class="gt-form-control" id="new_pass"
                                                    name="new_pass" data-validetta="required">
                                            </div>
                                            <div
                                                class="col-xs-16 col-sm-16 col-md-16 col-lg-16 col-xxl-10 col-xxl-offset-3 col-xl-10 col-xl-offset-3 gt-margin-bottom-15">
                                                <label>Confirm New Password</label>
                                                <input type="password" class="gt-form-control" id="cnfm_pass"
                                                    name="cnfm_pass" data-validetta="equalTo[new_pass]">
                                            </div>
                                            <div
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/js/validetta.js')); ?>"></script>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\setting\changepassword.blade.php ENDPATH**/ ?>