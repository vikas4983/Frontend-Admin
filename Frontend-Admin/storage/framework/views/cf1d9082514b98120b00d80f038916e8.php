<?php $__env->startSection('title', 'Location Search - Mangal Mandap'); ?>
        					...
        					<div class="col-xs-16 col-lg-16 col-xxl-12 col-xl-12 gt-search-opt mb-20">
        						<div role="tabpanel">
									...
									<div class="tab-content">
										...
										<!-- /.Keyword Search  --> 
										<!-- Location Search  --> 
    									<div role="tabpanel" class="tab-pane active" id="loc-search">
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
													<h3 class="inSearchTitle">
														Location Search													</h3>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\search\location.blade.php ENDPATH**/ ?>