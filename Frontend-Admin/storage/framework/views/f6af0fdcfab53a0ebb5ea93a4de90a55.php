                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="<?php echo e(route('myprofile.destroy', $admin->id)); ?>"
                                                            method="post">
                                                            <?php echo csrf_field(); ?>
                            ...
                            <div class="accordion" id="accordionOne">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseBorderOne1" class="collapse" aria-labelledby="headingBorderOne1"
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo e(route('myprofile.update', $admin->id)); ?>" method="post"
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\myprofile\index.blade.php ENDPATH**/ ?>