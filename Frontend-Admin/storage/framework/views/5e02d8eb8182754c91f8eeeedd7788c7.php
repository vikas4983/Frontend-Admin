...
<div class="content-wrapper">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('occupations.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                ...
                <select name="employee_id" id="" class="form-control">
                    ...
                    <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->employee); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="form-group">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\admin\employees\occupations\create.blade.php ENDPATH**/ ?>