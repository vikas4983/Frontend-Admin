<?php $__env->startSection('title', 'One-Way-Matches - Mangal Mandap'); ?>
 ...
 <div class="container">
        <div class="row">
           ...
           <div class="col-xxl-12 col-xl-12 col-xs-16" bis_skin_checked="1">
                <h3 class="inPageTitle fontMerriWeather inThemeOrange text-center">One Way Match</h3>
                <article class="text-center">
                    <p class="inPageSubTitle mb-20">
                       One Way Match is the profile show in perticular criteria at its best.its help you to find out your
                        life partner easily.
                    </p>
                </article>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\matches\oneway.blade.php ENDPATH**/ ?>