<?php $__env->startSection('title', 'I-View-Profile - Mangal Mandap'); ?>
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            <aside class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center mb-20">
                <h3 class="inPageTitle fontMerriWeather inThemeOrange">I Visited Profile</h3>
                <article>
                    <p class="inPageSubTitle">You can check all of your Visited Profile list here.</p>
                </article>
            </aside>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\iviewprofile.blade.php ENDPATH**/ ?>