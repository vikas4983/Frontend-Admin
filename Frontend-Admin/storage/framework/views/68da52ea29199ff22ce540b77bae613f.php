<?php $__env->startSection('title', 'Broders Matches - Mangal Mandap'); ?>
            ...
            <aside class="col-xxl-4 col-xl-4 col-xs-16">
                ...
                <div class="collapse mobile-collapse" id="collapseExample">
                    <ul class="my-match-aside mb-20 col-xs-16">
                        <li>
                            <a href="<?php echo e(url('one-way-matches')); ?>"><i class="fas fa-long-arrow-alt-right gt-margin-right-10"></i>One Way
                                Matches</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('two-way-matches')); ?>"><i class="fas fa-exchange-alt gt-margin-right-10"></i>Two Way
                                Matches</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('preferred-matches')); ?>"><i class="fas fa-star gt-margin-right-10"></i>Preferred Matches</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('broader-matches')); ?>"><i class="fa fa-arrows-alt gt-margin-right-10"></i>Broader Matches</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('custom-matches')); ?>"><i class="fa fa-tasks gt-margin-right-10"></i>Custom Matches</a>
                        </li>
                    </ul>
                </div>
            </aside>
           <div class="col-xxl-12 col-xl-12 col-xs-16" bis_skin_checked="1">
                <h3 class="inPageTitle fontMerriWeather inThemeOrange text-center">Broader Match</h3>
                <article class="text-center">
                    <p class="inPageSubTitle mb-20">
                        Broader match is the profile show in perticular criteria at its best.its help you to find out your
                        life partner easily.
                    </p>
                </article>
...
<?php echo $__env->make('layouts1.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\matches\broader.blade.php ENDPATH**/ ?>