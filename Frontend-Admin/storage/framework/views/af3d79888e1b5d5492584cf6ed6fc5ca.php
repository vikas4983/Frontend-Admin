        ...
        <div class="row">
            <div class="col-xxl-3 col-xl-4 col-xs-16 col-sm-16">
                <div class="thumbnail gt-margin-bottom-0">
                    <img src="<?php echo e(asset('storage/user/images/' . ($user->image ?? 'male-default.jpg'))); ?>" alt="User Image"
                ...
                <div class="gt-panel gt-panel-default inViewProfile" id="edit1">
                    <div class="gt-panel-head">
                        ...
                        <a class="pull-right btn gt-btn-orange" data-toggle="modal" data-backdrop ="static"
                            data-keyboard="false" data-target="#abc" data-info=<?php echo e($user->id); ?>>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <b><input type="text" name="name" id="name"
                                                                    value="<?php echo e(old('name', $user->name ?? 'NA')); ?>"></b>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <b><input type="text" name="email" id="email"
                                                                    value="<?php echo e(old('email', $user->email ?? 'NA')); ?>"></b>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <b><input type="text" id="mobile" name="mobile"
                                                                    value="<?php echo e(old('mobile', $user->mobile ?? 'NA')); ?>"></b>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <b><input type="text" id="gender" name="gender"
                                                                    value="<?php echo e(old('gender', $user->gender ?? 'NA')); ?>"></b>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.frontend.main-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\premiumMangalMandap\resources\views\frontend\users\myProfile.blade.php ENDPATH**/ ?>